...
<style scoped>
  ...
  .detail-right__buy:hover:before{
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
    background: #B4BAFD;
    border: 1px solid #B4BAFD;
  ...
  .detailPage-back:hover{
    color: #fff;
  }
  .detailPage-back:hover:before{
    width: 100%;
    left: 0;
  }
  .detail-right__buy svg{
    position: absolute;
    top: 50%;
    left: 50%;
    width: 30px;
